...
<?php include("header.php");  ?>
	...
	<script src="js/DivDropdown.js"></script>
</head>
<meta charset="UTF-8">
...
<?php
			$abfrage = "SELECT ID,Questions, QuestionDefinition, oldQuestion FROM questions WHERE CategoryIDFK = 1";
		...
		?>
			...
			<details>
		<summary><h3 id="questionTitle">solved Questions</h3></summary>
										
			<?php 									

				$abfrage = "SELECT ID,Questions, QuestionDefinition, oldQuestion,CategoryIDFK FROM questions WHERE CategoryIDFK =1";
				$ergebnis = mysql_query($abfrage);
				$i = 1;
